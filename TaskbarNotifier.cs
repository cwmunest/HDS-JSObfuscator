...
namespace HDS.JSObfuscator
{
    ...
    public delegate void OnBarClick(TaskbarNotifier tnf);
    ...
    public class TaskbarNotifier : System.Windows.Forms.Form
    {
        ...
        public OnBarClick onclick = null;
        public int Index = -1;
        ...
        public TaskbarNotifier(Form fm)
        {
            this.MainForm = fm;
            // Window Style
        ...
        public void Show(string strTitle, string strContent, int nTimeToShow, int nTimeToStay, int nTimeToHide)
        {
            ...
            switch (taskbarState)
            {
                case TaskbarStates.hidden:
                    ...
                    //SetBounds(WorkAreaRectangle.Right - BackgroundBitmap.Width - 2, WorkAreaRectangle.Bottom - 1 - BackgroundBitmap.Height * Index, BackgroundBitmap.Width, 0);
                    SetBounds(this.MainForm.Right - BackgroundBitmap.Width - 0, this.MainForm.Bottom - 1 - BackgroundBitmap.Height * Index, BackgroundBitmap.Width, 0);
                ...
                case TaskbarStates.disappearing:
                    ...
                    SetBounds(this.MainForm.Right - BackgroundBitmap.Width - 17, this.MainForm.Bottom - BackgroundBitmap.Height - 1, BackgroundBitmap.Width, BackgroundBitmap.Height);
                    timer.Interval = nVisibleEvents;
                    timer.Start();
                    Refresh();
                    break;
        ...
        private void InitializeComponent()
        {
            ...
            this.VisibleChanged += new System.EventHandler(this.TaskbarNotifier_VisibleChanged);
            this.ResumeLayout(false);

        }

        private void TaskbarNotifier_VisibleChanged(object sender, EventArgs e)
        {
